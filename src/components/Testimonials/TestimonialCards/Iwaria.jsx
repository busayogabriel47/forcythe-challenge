import iwaria from "../../../assets/iwaria-founder.svg"
    ...
    return (
        <>
            <div className="flex w-[50%] h-[100%] p-[1.5rem] gap-5 bg-[#0C2645] rounded-[1.7rem]">
                ...
                <div className="w-[45%] h-[300px] bg-cover bg-center rounded-[1.2rem]" style={{backgroundImage: `url(${iwaria})`}}>
